public class Greed{
  ...
  //Ideally this would be compartmentalized into another class, for the purpose of a Kata it's all in one place
  //Iterates through dice results to tally points based on sets of 3 equivalent dice roll or one and five die rolls
